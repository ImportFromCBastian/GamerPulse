...
const DashboardPage = () => {
  ...
  return (
    <div className='fondo'>
      ...
      {Array.isArray(juegos) && juegos.map(({id,nombre,imagen,tipo_imagen,descripcion,url,nomGen,nomPlat}) => (
          <Game key={id} elem={{nombre,imagen,tipo_imagen,descripcion,url,nomGen,nomPlat}} />
        ))}
        {vacio ? (
