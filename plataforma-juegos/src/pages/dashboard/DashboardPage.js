...
const DashboardPage = () => {
  ...
  return (
    <div className='fondo'>
      ...
      {Array.isArray(juegos) && juegos.map(({id,nombre,imagen,tipo_imagen,descripcion,url,nomPlat,nomGen}) => (
          <Game key={id} elem={{nombre,imagen,tipo_imagen,descripcion,url,nomPlat,nomGen}} />
        ))}
        {vacio ? (
